...
export const creativeApi = {
  ...
  analyzeUrl: (url: string) =>
    D<{ name?: string; category?: string; description?: string; features?: string[]; colors?: string[]; price?: string; audience?: string; context?: string; imageUrl?: string }>(api.post('/creative/analyze-url', { url }, { timeout: 60_000 })),
  ...
  composeScene: (body: { product: ProductInfo; referenceImages?: string[]; referenceImage?: string; format?: Fmt; category?: string; quality?: 'standard' | 'premium' }) =>
    D<{ imageUrl: string; backgroundUrl?: string; cutoutUrls?: string[]; credits: number; creditsUsed: number }>(api.post('/creative/compose-scene', body, { timeout: 180_000, ...idem() })),
  ...
  ugcOneShot: (body: { product: ProductInfo; referenceImages?: string[]; referenceImage?: string; avatarImage?: string; avatarDesc?: string; brief?: string; scriptOverride?: string; quality?: 'standard' | 'premium'; videoQuality?: string; format?: Fmt; duration?: '5' | '10'; exactProducts?: boolean; baseImage?: string }) =>
